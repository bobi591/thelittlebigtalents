...
export const metadata: Metadata = {
  title: 'Поп и джаз пеене – Музикален Център "Малките Големи Таланти"',
  description:
    'Научете повече за уроците по поп и джаз пеене, преподавани в Музикален Център "Малките Големи Таланти".',
};
