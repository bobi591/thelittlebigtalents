...
export const metadata: Metadata = {
  title: 'Барабани – Музикален Център "Малките Големи Таланти"',
  description:
    'Научете повече за уроците по барабани, преподавани в Музикален Център "Малките Големи Таланти".',
};
        ...
        <PageSectionStack bgColor={'bg.muted'}>
          ...
          <Stack flex={1}>
            ...
            <List.Root>
              ...
              <List.Item>{`Музициране в група и камерен състав`}</List.Item>
              <List.Item>{`Подготовка за концерти и сценични изяви`}</List.Item>
            </List.Root>
          </Stack>
        </PageSectionStack>
      </Stack>
