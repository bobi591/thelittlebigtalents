...
const Page: React.FC = () => {
  return (
    <Stack alignItems={'center'}>
      ...
      />
      <Stack margin={'auto'} gap={5} w={'100vw'} p={10}>
        <Text>
          Обучителният процес на подготовка за кандидатстване във висши учебни заведения по музика е
          продължителен и изключително сериозен. В кандидатстудентските изпити е включен материал,
          който се изучава с години в музикални училища и паралелки. Нужни са определи умения и
          знания, които не могат да се придобият за една или две години музициране. А за някои
          специалности се изисква подготовка и по облигатно (задължително) пиано.
        </Text>
        <Text pb={5}>
